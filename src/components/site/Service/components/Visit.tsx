export const Visit = () => (
  <div className="mt-0 md:mt-4 rounded-3xl border bg-card p-6 shadow-sm">
    ...
    <ul className="mt-4 grid gap-2 text-sm text-muted-foreground">
      ...
      <li>
        • Debes indicarme dónde y qué productos de limpieza utilizar, así como
        dónde se encuentra su comida, juguetes, chuches…
      </li>
      <li>
      ...
      <li>
        • Tras la visita, os mandaré un mensaje con el resúmen de la misma y/o
        cosas relevantes, y si quieres, fotos y vídeos.
      </li>
      <li>
        • Si quieres verlos en “directo” para mandarles una saludito si les
        echas de menos, durante mi visita, podemos realizar una videollamada.
      </li>
      <li>
