export const items = [
  ...
  {
    q: '¿Qué pasa si mi gato se pone agresivo o miedoso durante la visita?',
    a: 'Primero, respecto siempre sus límites. Si muestra estrés o agresividad, detengo la interacción y busco alternativas para que la visita siga siendo segura y calmada. La seguridad y bienestar de tu gato es mi prioridad.',
  },
  {
    q: '¿Qué hago si mi gato necesita atención veterinaria durante el servicio?',
    a: 'En caso de urgencia o necesidad médica te contactaré inmediatamente y, si es necesario, lo llevaré al veterinario de tu confianza. Siempre mantengo informado al tutor sobre cualquier situación relevante.',
  },
  {
    q: '¿Qué forma de pago aceptas?',
    a: 'Acepto transferencia bancaria, Bizum o pago en efectivo, según lo que te resulte más cómodo.',
  },
  {
    q: '¿Puedo cancelar o cambiar el servicio?',
    a: 'Sí, se pueden realizar cambios o cancelaciones avisando con al menos 24h de antelación, en caso de urgencia siempre busco la mejor solución para tu gato y tu planificación.',
  },
  {
